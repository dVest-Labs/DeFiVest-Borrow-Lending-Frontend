...
const VotePageLeftSide = ({ loading }: Props) => {
  return (
    <>
      {!loading ? (
        <div className="box-shadow-inner  flex md:col-start-1 md:col-end-3 mb-10 rounded-lg shadow-2xl">
          <div className="">
            ...
            <div className="pl-7 h-20 border-b-1 border-underlinecl text-lg flex flex-col justify-center">
              ...
              <div className="tracking-wider">
                <div className="flex items-center text-xl">
                  <span className="text-label">0.0000</span>
                  <img
            ...
            <div className="pb-5">
              <div className="text-label pl-7 h-14 text-lg flex items-center">
                Setup Voting
              </div>
